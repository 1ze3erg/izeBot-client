    ...
    return (
        <div className="grid grid-cols-5 lg:grid-cols-1 md:contents">
            ...
            <div className="col-span-4 bg-gray-400 p-5">
                ...
                <div className="grid grid-cols-2 gap-8 md:grid-cols-1 text-white">
                    <div className="bg-indigo-900 border-4 border-indigo-400 ring-4 ring-indigo-400 rounded-lg text-center p-5">
