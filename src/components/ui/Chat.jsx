function Chat({ displayName, message, role }) {
    const icon = role === "MEMBER" ? (
        <i className="fas fa-user bg-gray-300 text-indigo-700 px-4 py-2 mr-2 rounded-md" title="MEMBER"></i>
    ) : (
        <i className="fas fa-robot bg-gray-300 text-indigo-700 px-2 py-2 mr-2 rounded-md" title="BOT"></i>
    );
